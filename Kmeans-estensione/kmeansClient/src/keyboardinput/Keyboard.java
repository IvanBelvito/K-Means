...
/**
 * Classe utilizzata per leggere un input da tastiera. (Avendo impelementato un'interfaccia grafica, la classe non viene più utilizzata)
 * Si è scelto di mantenerla per eventuali estensioni future.
 */
